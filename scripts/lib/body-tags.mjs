export const bodyTagDefinitions = [
  ...
  },
  {
    tag: "胴詰まり",
    category: "体型",
    confirmed: [/胴詰まり/, /寸(?:の)?詰まり/, /胴[^。]*詰ま/, /(?<!実の)(?<!中身の)詰ま(?:った|り気味)[^。]*(?:体型|馬体|フォルム|バランス)/, /前後[^。]*詰ま/],
  ...
  },
  {
    tag: "首長",
    category: "体型",
    confirmed: [/(?:首|クビ)さし[^。]{0,14}(?:長い|長め|長く|長さ)/, /(?:首|クビ)[^。]{0,10}(?:長い|長め|長く|長さ)/],
    suggested: []
  },
  {
    tag: "首短",
    category: "体型",
    confirmed: [/(?:首|クビ)さし[^。]{0,14}(?:短い|短め|短く)/, /(?:首|クビ)[^。]{0,10}(?:短い|短め|短く)/],
    suggested: []
  },
  {
    tag: "直飛",
